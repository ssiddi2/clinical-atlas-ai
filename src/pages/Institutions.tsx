        ...
        <section className="py-20">
          ...
          <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Why Institutions Choose LIVEMED University
              </h2>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  ...
                  deployment and ongoing optimization of the LIVEMED University platform.
                </p>
              ...
              <Card className="gradient-livemed text-white">
                <CardContent className="p-8">
                  ...
                  <p className="text-white/80 mb-6">
                    ...
                    how LIVEMED University can support your medical education goals.
                  </p>
