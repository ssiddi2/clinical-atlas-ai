...
const Landing = () => {
  ...
  const features = [
    {
      icon: Brain,
      title: t("features.atlas.title"),
      description: t("features.atlas.description"),
    },
    {
      icon: Stethoscope,
      title: t("features.rotations.title"),
      description: t("features.rotations.description"),
      subtitle: t("features.rotations.subtitle"),
    },
    {
      icon: BookOpen,
