...
const DashboardScene = ({ isActive }: DashboardSceneProps) => {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center p-8">
      ...
      >
        <div className="w-12 h-12 rounded-xl bg-livemed-blue/20 flex items-center justify-center">
          <BarChart3 className="h-6 w-6 text-livemed-blue" />
        </div>
        <div>
          <h3 className="text-xl font-semibold text-white">Student Dashboard</h3>
          <p className="text-sm text-white/50">Track your progress in real-time</p>
        </div>
      </motion.div>
      ...
      <div className="w-full max-w-2xl grid grid-cols-2 gap-4">
        ...
        >
          <h4 className="text-sm font-medium text-white/80 mb-4">Module Progress</h4>
        ...
        <motion.div
          ...
          className="glass-card rounded-2xl p-6"
        >
          <h4 className="text-sm font-medium text-white/80 mb-4">Achievements</h4>
          <div className="space-y-3">
            {achievements.map((achievement, idx) => (
              ...
              >
                <div className="w-10 h-10 rounded-lg gradient-livemed flex items-center justify-center flex-shrink-0">
      ...
      <motion.div
        ...
        className="w-full max-w-2xl grid grid-cols-3 gap-4 mt-4"
      >
        {[
          ...
          >
            <p className="text-2xl font-semibold text-gradient-livemed">{stat.value}</p>
